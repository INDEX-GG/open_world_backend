...
urlpatterns = [
    ...
    path('auth/registration/email-for-verifications/', views.EmailForVerificationView.as_view()),
    path('auth/registration/verify-code/', views.VerifyCodeAPIView.as_view()),
